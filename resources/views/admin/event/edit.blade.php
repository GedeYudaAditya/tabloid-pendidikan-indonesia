    ...
    <div class="container mb-3">
        ...
        <form action="{{ route('admin.event.update', $event->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img alt="" id="preview" class="img-fluid" src="{{ asset('img/event/' . $event->gambar) }}">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="isi" id="isi" rows="3">{{ $event->isi }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="jenis" id="jenis">
                    <option value="seminar" @if ($event->jenis == 'seminar') selected @endif>Seminar</option>
                    <option value="workshop" @if ($event->jenis == 'workshop') selected @endif>workshop</option>
                </select>
            </div>
