...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Manajemen Buku | Edit Buku</h1>
    ...
    <div class="container mb-3">
        ...
        <form action="{{ route('admin.buku.update', $buku->id) }}" method="post" enctype="multipart/form-data">
            ...
            {{-- Thumbnail berita --}}
            <div class="mb-3">
                <label for="thumbnail" class="form-label">File Foto Buku</label>
            ...
            <div class="mb-3">
                ...
                <img alt="" id="preview" class="img-fluid" src="{{ asset('img/buku/' . $buku->gambar) }}">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="sinopsis" id="isi" rows="3">{{ $buku->sinopsis }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="status" id="status">
                    <option value="publish" @if ($buku->status == 'publish') selected @endif>Terbit</option>
                    <option value="draft" @if ($buku->status == 'draft') selected @endif>Belum Terbit</option>
                </select>
            </div>
