...
@section('content')
    @if (isset($hari_peringatan) || isset($sekaps))
        <div class="row my-3">
            {{-- berita terkini --}}
            @if (isset($hari_peringatan))
                <div class="{{ !isset($sekaps) ? 'col-md-12' : 'col-md-7' }}">
            ...
            @if (isset($sekaps))
                {{-- berita terpopuler --}}
                <div class="{{ !isset($hari_peringatan) ? 'col-md-12' : 'col-md-5' }}">
        ...
        <div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        {!! Share::page(url(route('guest.berita.detail', $daerah->slug)))->facebook()->twitter()->whatsapp()->telegram() !!}
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    </div>
